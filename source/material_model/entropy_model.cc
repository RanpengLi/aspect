                          ...
                          if (reaction_rate_out != nullptr)
                            {
                              ...
                              if (c == entropy_indices[j] && timestep_number > 0)
                                reaction_rate_out->reaction_rates[i][c] = (composition_equalibrated_S[j] - in.composition[i][entropy_indices[j]]) / this->get_timestep();
